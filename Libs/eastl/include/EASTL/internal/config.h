...
// Begin seagull's config override
namespace eastl
{
...
///////////////////////////////////////////////////////////////////////////////
		...
		#define EASTL_ASSERT(expression) SG_ASSERT(expression);
	#else
		#define EASTL_ASSERT(expression)
	#endif
#endif
...
///////////////////////////////////////////////////////////////////////////////
		...
		//	} while (0) \
		//	EA_RESTORE_VC_WARNING()
		#define EASTL_ASSERT_MSG(expression, message) SG_ASSERT(expression && #message);
	#else
		#define EASTL_ASSERT_MSG(expression, message)
	#endif
#endif
...
///////////////////////////////////////////////////////////////////////////////
	...
	#if EASTL_ASSERT_ENABLED
#define EASTL_FAIL_MSG(message) SG_ASSERT(false && #message);
	#else
